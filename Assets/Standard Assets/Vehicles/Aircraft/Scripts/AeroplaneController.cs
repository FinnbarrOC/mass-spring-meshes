...
namespace UnityStandardAssets.Vehicles.Aeroplane
{
    ...
    public class AeroplaneController : MonoBehaviour
    {
        ...
        [SerializeField] private float m_StrafeEffect = 1f;           // The strength of effect for strafe input
        ...
        public void Move(float rollInput, float pitchInput, float yawInput, float throttleInput, bool airBrakes, float strafeInput)
        {
            ...
            m_Rigidbody.AddForce(transform.right * (StrafeInput * m_StrafeEffect * m_Rigidbody.velocity.magnitude));
            //Debug.Log(transform.right * (StrafeInput * Time.fixedDeltaTime * m_StrafeEffect));
        }
